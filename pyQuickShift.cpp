/* Generated by Cython 0.15.1 on Mon Jun 25 16:30:56 2012 */
...
static char __pyx_k__quickShift[] = "quickShift";
...
static PyObject *__pyx_n_s__quickShift;
 ...
 * 
 * 
 * def quickShift(np.ndarray[np.uint8_t] im):             # <<<<<<<<<<<<<<
 * 	cdef int height = im.shape[0]
 * 	cdef int width = im.shape[1]
 */

static PyObject *__pyx_pf_12pyQuickShift_quickShift(PyObject *__pyx_self, PyObject *__pyx_v_im); /*proto*/
static PyMethodDef __pyx_mdef_12pyQuickShift_quickShift = {__Pyx_NAMESTR("quickShift"), (PyCFunction)__pyx_pf_12pyQuickShift_quickShift, METH_O, __Pyx_DOCSTR(0)};
static PyObject *__pyx_pf_12pyQuickShift_quickShift(PyObject *__pyx_self, PyObject *__pyx_v_im) {
  int __pyx_v_height;
  int __pyx_v_width;
  ...
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("quickShift");
  __pyx_self = __pyx_self;
  __pyx_bstruct_im.buf = NULL;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_im), __pyx_ptype_5numpy_ndarray, 1, "im", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_im, (PyObject*)__pyx_v_im, &__Pyx_TypeInfo_nn___pyx_t_5numpy_uint8_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
 ...
 * 	cdef int channels = 1
 */
  __pyx_v_height = (((PyArrayObject *)__pyx_v_im)->dimensions[0]);
 ...
 * 
 */
  __pyx_v_width = (((PyArrayObject *)__pyx_v_im)->dimensions[1]);
 ...
 * 
 */
  __pyx_t_1 = (((PyArrayObject *)__pyx_v_im)->nd > 2);
  if (__pyx_t_1) {
 ...
 * 		channels = im.shape[2]             # <<<<<<<<<<<<<<
 * 
 * 	cdef VlQS* obj = vl_quickshift_new(<double*>im.data, width, height, channels)
 */
    __pyx_v_channels = (((PyArrayObject *)__pyx_v_im)->dimensions[2]);
    goto __pyx_L5;
  }
  __pyx_L5:;
 ...
 */
  __pyx_v_obj = vl_quickshift_new(((double *)((PyArrayObject *)__pyx_v_im)->data), __pyx_v_width, __pyx_v_height, __pyx_v_channels);
 ...
 * 
 * 
 * 	labels = np.PyArray_SimpleNewFromData(2, im.shape, np.NPY_DOUBLE, <void*> obj)             # <<<<<<<<<<<<<<
 * 	return labels
 */
  __pyx_t_2 = PyArray_SimpleNewFromData(2, ((PyArrayObject *)__pyx_v_im)->dimensions, NPY_DOUBLE, ((void *)__pyx_v_obj)); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 28; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  ...
  __Pyx_AddTraceback("pyQuickShift.quickShift", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_bstruct_im);
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s__quickShift, __pyx_k__quickShift, sizeof(__pyx_k__quickShift), 0, 0, 1, 1},
...
#endif
{
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("pyQuickShift"), __pyx_methods, 0, 0, PYTHON_API_VERSION);
  #else
 ...
 * 	cdef int width = im.shape[1]
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_12pyQuickShift_quickShift, NULL, __pyx_n_s__pyQuickShift); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyObject_SetAttr(__pyx_m, __pyx_n_s__quickShift, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

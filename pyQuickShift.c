/* Generated by Cython 0.15.1 on Tue Jun 26 15:20:17 2012 */
...
static PyObject *__pyx_pf_12pyQuickShift_quickshift_2D(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_self = __pyx_self;
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "quickshift_2D") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 79; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    } else {
      switch (PyTuple_GET_SIZE(__pyx_args)) {
        case  3: values[2] = PyTuple_GET_ITEM(__pyx_args, 2);
    ...
    if (values[1]) {
      __pyx_v_kernelSize = __pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_kernelSize == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 79; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
      __pyx_v_kernelSize = ((double)2.0);
    }
    if (values[2]) {
      __pyx_v_maxDist = __pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_maxDist == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 79; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
  ...
  __Pyx_RaiseArgtupleInvalid("quickshift_2D", 0, 1, 3, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 79; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_im), __pyx_ptype_5numpy_ndarray, 1, "im", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 79; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_im, (PyObject*)__pyx_v_im, &__Pyx_TypeInfo_nn___pyx_t_5numpy_double_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 79; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
 ...
 */
  __pyx_t_4 = PyArray_SimpleNewFromData(2, __pyx_v_shape, NPY_INT32, ((void *)__pyx_v_parents)); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 118; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 * 
 */
  __pyx_t_4 = PyArray_SimpleNewFromData(2, __pyx_v_shape, NPY_DOUBLE, ((void *)__pyx_v_distances)); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 119; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
 ...
 */
  __pyx_t_4 = PyArray_SimpleNewFromData(2, __pyx_v_shape, NPY_DOUBLE, ((void *)__pyx_v_density_)); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 120; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_v_density = __pyx_t_4;
  __pyx_t_4 = 0;

  /* "pyQuickShift.pyx":124
 * 	# vl_quickshift_delete (obj)
 * 
...
static PyObject *__pyx_pf_12pyQuickShift_1quickshift_3D(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_self = __pyx_self;
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "quickshift_3D") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 128; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    } else {
      switch (PyTuple_GET_SIZE(__pyx_args)) {
        case  3: values[2] = PyTuple_GET_ITEM(__pyx_args, 2);
    ...
    __pyx_v_im = ((PyArrayObject *)values[0]);
    if (values[1]) {
      __pyx_v_kernelSize = __pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_kernelSize == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 128; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
      __pyx_v_kernelSize = ((double)2.0);
    }
    if (values[2]) {
      __pyx_v_maxDist = __pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_maxDist == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 128; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
      __pyx_v_maxDist = ((double)-1.0);
    }
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("quickshift_3D", 0, 1, 3, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 128; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  ...
  __pyx_L4_argument_unpacking_done:;
  __pyx_bstruct_im.buf = NULL;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_im), __pyx_ptype_5numpy_ndarray, 1, "im", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 128; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_im, (PyObject*)__pyx_v_im, &__Pyx_TypeInfo_nn___pyx_t_5numpy_double_t, PyBUF_FORMAT| PyBUF_STRIDES, 3, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 128; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
 ...
 * 	density = np.PyArray_SimpleNewFromData(2, shape, np.NPY_DOUBLE, <void*>density_)
 */
  __pyx_t_4 = PyArray_SimpleNewFromData(2, __pyx_v_shape, NPY_INT32, ((void *)__pyx_v_parents)); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 167; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_v_npLabels = __pyx_t_4;
  __pyx_t_4 = 0;

  /* "pyQuickShift.pyx":168
 * 	shape[1] = width
 * 	npLabels = np.PyArray_SimpleNewFromData(2, shape, np.NPY_INT32, <void*>parents)
 * 	dists = np.PyArray_SimpleNewFromData(2, shape, np.NPY_DOUBLE, <void*>distances)             # <<<<<<<<<<<<<<
 * 	density = np.PyArray_SimpleNewFromData(2, shape, np.NPY_DOUBLE, <void*>density_)
 * 
 */
  __pyx_t_4 = PyArray_SimpleNewFromData(2, __pyx_v_shape, NPY_DOUBLE, ((void *)__pyx_v_distances)); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 168; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_v_dists = __pyx_t_4;
  __pyx_t_4 = 0;

  /* "pyQuickShift.pyx":169
 * 	npLabels = np.PyArray_SimpleNewFromData(2, shape, np.NPY_INT32, <void*>parents)
 * 	dists = np.PyArray_SimpleNewFromData(2, shape, np.NPY_DOUBLE, <void*>distances)
 * 	density = np.PyArray_SimpleNewFromData(2, shape, np.NPY_DOUBLE, <void*>density_)             # <<<<<<<<<<<<<<
 * 
 * 	# vl_quickshift_delete (obj)
 */
  __pyx_t_4 = PyArray_SimpleNewFromData(2, __pyx_v_shape, NPY_DOUBLE, ((void *)__pyx_v_density_)); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 169; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_v_density = __pyx_t_4;
  __pyx_t_4 = 0;

  /* "pyQuickShift.pyx":173
 * 	# vl_quickshift_delete (obj)
 * 
 * 	return npLabels, dists, density             # <<<<<<<<<<<<<<
 */
 ...
 * 
 */
  __pyx_t_1 = __Pyx_Import(((PyObject *)__pyx_n_s__numpy), 0, -1); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 52; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyObject_SetAttr(__pyx_m, __pyx_n_s__np, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 52; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 * 	cdef int width = im.shape[1]
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_12pyQuickShift_quickshift_2D, NULL, __pyx_n_s__pyQuickShift); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 79; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyObject_SetAttr(__pyx_m, __pyx_n_s__quickshift_2D, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 79; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 * 	cdef int width = im.shape[1]
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_12pyQuickShift_1quickshift_3D, NULL, __pyx_n_s__pyQuickShift); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 128; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyObject_SetAttr(__pyx_m, __pyx_n_s__quickshift_3D, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 128; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
